...
const Navbar = () => {
    ...
    return (
        <nav className="relative bg-white">
           ...
           <span className="absolute -top-1 -right-1 text-[8px] bg-slate-600 text-white size-4 rounded-full flex items-center justify-center">
        {cartCount}
      </span>
    </Link>
  ) : (
    <div className="w-[22px] h-[22px]" />   // 👈 space holder
  )}
                    {
                        user?(
                             <div>
